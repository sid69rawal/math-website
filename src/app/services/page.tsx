    ...
    <div className="min-h-screen bg-gray-50 pt-32">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {gradeCategories.map((grade, index) => (
              <motion.div
                key={grade.id}
                className="bg-gray-200 rounded-xl p-3 sm:p-6 lg:p-8 shadow-lg border border-gray-300 hover:bg-gray-300 hover:border-blue-600 hover:shadow-xl hover:scale-105 transition-all duration-300 group text-center flex flex-col min-h-[200px] sm:min-h-[320px]"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ 
                  delay: 0.6 + index * 0.1,
              ...
              >
                ...
                {/* Grade Description */}
                <p className="text-sm sm:text-base lg:text-lg text-gray-600 mb-4 sm:mb-8 lg:mb-10 flex-grow leading-relaxed">
                  {grade.description}
                </p>
                ...
                <button
                  ...
                  className="w-1/2 mx-auto sm:w-full text-white px-2 sm:px-6 py-2 sm:py-4 rounded-lg font-semibold text-sm sm:text-base lg:text-lg transition-all duration-200 hover:opacity-90 mt-auto shadow-md" 
                  style={{ backgroundColor: '#30519d' }}
                >
                  Learn More
                </button>
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          >
            <motion.div
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 w-full max-w-4xl max-h-[calc(100vh-8rem)] sm:max-h-[calc(100vh-4rem)] overflow-y-auto shadow-2xl"
