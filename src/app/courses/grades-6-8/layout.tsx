...
export const metadata: Metadata = {
  ...
  keywords: "math tutor Mississauga grades 6-8, math tutoring, middle school math tutoring Mississauga, math tutor for grade 6, grade 6 math help, grade 7 math tutoring, grade 8 math programs, EQAO math prep Ontario, algebra tutoring",
  openGraph: {
