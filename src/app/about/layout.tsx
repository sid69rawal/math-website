...
export const metadata: Metadata = {
  ...
  keywords: "about Level Up Math Academy, math tutor Mississauga, math tutors Mississauga, expert math tutor, expert math teachers, math tutoring experience, personalized math instruction",
  openGraph: {
