            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  ...
                  >
                        With <span className="font-bold" style={{ color: '#30519d' }}>20+ years in the IT industry</span> and a deep-rooted passion for education, Jyoti brings a rich blend of <span className="font-bold" style={{ color: '#30519d' }}>analytical precision and creative instruction</span>. She holds a B.E. in Computer Science from NIT Jamshedpur, India and an M.S. in Computer Science from Georgia State University, USA. Her teaching journey spans <span className="font-bold" style={{ color: '#30519d' }}>India, the USA, and Canada</span>, where she has supported students across all grade levels through both volunteer and professional roles. Jyoti specializes in <span className="font-bold" style={{ color: '#30519d' }}>mental math, algebra, trigonometry, functions, advanced functions, calculus, vectors</span>, and <span className="font-bold" style={{ color: '#30519d' }}>math contest preparation</span> (Waterloo, Math League, SAT, GMAT, GRE).
                  </motion.p>
          ...
          <div className="text-center mb-12">
            ...
            {teachingApproaches.map((approach, index) => {
              return (
                <motion.div
                  key={index}
                  className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 transition-all duration-300 hover:bg-gray-200 hover:from-gray-200 hover:to-gray-200 hover:border-blue-600 hover:shadow-xl hover:scale-105 group flex flex-col min-h-[300px] sm:min-h-[320px]"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ 
                    delay: 0.6 + index * 0.1,
